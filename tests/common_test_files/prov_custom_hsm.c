...
// For more information please see the devdoc using_prov_custom_hsm.md
...
void prov_custom_hsm_destroy(HSM_CLIENT_HANDLE handle)
{
    if (handle != NULL)
    {
...
char* prov_custom_hsm_get_certificate(HSM_CLIENT_HANDLE handle)
{
    char* result;
    if (handle == NULL)
    {
...
char* prov_custom_hsm_get_key(HSM_CLIENT_HANDLE handle)
{
    char* result;
    if (handle == NULL)
    {
...
char* prov_custom_hsm_get_common_name(HSM_CLIENT_HANDLE handle)
{
    char* result;
    if (handle == NULL)
    {
...
int prov_custom_hsm_activate_identity_key(HSM_CLIENT_HANDLE handle, const unsigned char* key, size_t key_len)
{
    int result;
...
{
    prov_custom_hsm_create,
    prov_custom_hsm_destroy,
    prov_custom_hsm_get_certificate,
    prov_custom_hsm_get_key,
    prov_custom_hsm_get_common_name
};
...
static const HSM_CLIENT_TPM_INTERFACE tpm_interface =
{
    prov_custom_hsm_create,
    prov_custom_hsm_destroy,
    prov_custom_hsm_activate_identity_key,
    prov_custom_hsm_get_endorsement_key,
    prov_custom_hsm_get_storage_root_key,
    prov_custom_hsm_sign_with_identity
};
...
static const HSM_CLIENT_KEY_INTERFACE symm_key_interface =
{
    prov_custom_hsm_create,
    prov_custom_hsm_destroy,
    prov_custom_hsm_symm_key,
    prov_custom_hsm_get_registration_name
};
